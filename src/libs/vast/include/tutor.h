 ...
 * Description:
 *      All tutor declarations used to help map logic, so you can see how VAST evaluated an equation.
 */
...
/**
 * @brief Grabs the Tutor log used to help explain how VAST evaluated an equation.
 * 
